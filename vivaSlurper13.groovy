...
@Grapes([
	...
	@Grab(group='org.hsqldb', module='hsqldb', version='2.3.1')
])
...
db = Sql.newInstance(
	...
	'jdbc:hsqldb:mem:vivaSlurper', //'jdbc:hsqldb:file:/home/gerjan/Desktop/GinA',
	'sa',
	'',
...
db.execute '''
    DROP INDEX messageindex IF EXISTS;
    CREATE INDEX messageindex ON messsage (id);
'''

db.execute '''
    INSERT INTO message (content, url) VALUES ('Foo', 'http://foo');
    INSERT INTO message (content, url) VALUES ('Bar', 'http://bar');
    INSERT INTO message (content, url) VALUES ('Baz', 'http://baz');
'''
